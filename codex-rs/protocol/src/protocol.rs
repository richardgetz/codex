...
pub struct Submission {
    ...
    /// Payload
    pub op: Op,
    /// Optional client-provided identifier for a user message.
...
impl SubAgentSource {
    pub fn kind(&self) -> &str {
        match self {
            ...
            SubAgentSource::MemoryExtraction => "memory_extraction",
...
mod tests {
    ...
    fn token_usage_info_attributes_model_and_service_tier_usage() {
        ...
        let expected = TokenUsageInfo {
            ...
            usage_by_service_tier: BTreeMap::from([("priority".to_string(), usage.clone())]),
