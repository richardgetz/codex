...
pub mod legacy_core {
    ...
    pub use codex_core::OrchestratorMemoryPruneResult;
    pub use codex_core::ScratchpadAbsorbOptions;
    pub use codex_core::ScratchpadAbsorbResult;
    pub use codex_core::absorb_thread_scratchpad_context;
    ...
    pub use codex_message_history::append_entry as append_message_history_entry;
