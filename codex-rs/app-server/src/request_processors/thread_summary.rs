...
pub(crate) fn thread_settings_from_config_snapshot(
    ...
    ThreadSettings {
        ...
        team: super::team_settings_from_core(config_snapshot.team.clone()),
    }
}
...
pub(crate) fn thread_settings_from_core_snapshot(
    ...
    ThreadSettings {
        ...
        service_tier: service_tier.or_else(|| Some(SERVICE_TIER_DEFAULT_REQUEST_VALUE.to_string())),
        ...
        team: super::team_settings_from_core(team),
    }
}
#[cfg(test)]
