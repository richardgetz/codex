...
use codex_core_api::AccountsConfig;
...
use codex_core_api::ResumeConfig;
use codex_core_api::ScheduleConfig;
...
fn new_config(model: Option<String>, arg0_paths: Arg0DispatchPaths) -> anyhow::Result<Config> {
    ...
    let mut config = Config {
        ...
        agent_max_depth: 1,
        agent_max_depth_explicit: false,
        agent_roles: BTreeMap::new(),
        team: Default::default(),
        team_runtime_profiles: None,
        team_mode: Default::default(),
        team_state_persisted: false,
