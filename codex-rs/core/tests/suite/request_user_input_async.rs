...
#[test_case(Some(ToolMessages { send_user_message_async: None }), "send_user_message_async", true; "missing_tool")]
#[test_case(Some(ToolMessages { send_user_message_async: Some(ToolMessage::default()) }), "send_user_message_async", true; "missing_description")]
#[test_case(Some(ToolMessages { send_user_message_async: Some(ToolMessage { description: Some("Catalog async message description.".to_string()) }) }), "send_user_message_async", true; "catalog_description")]
#[test_case(Some(ToolMessages { send_user_message_async: Some(ToolMessage { description: Some(String::new()) }) }), "send_user_message_async", true; "empty_description")]
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
